...
usuarioSchema.methods.generarTokenRecuperacion = function() {
  ...
  this.fechaTokenRecuperacion = Date.now() + 10 * 60 * 1000; // 10 minutos
  return token;
};
