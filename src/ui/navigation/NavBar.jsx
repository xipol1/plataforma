  ...
  return (
    <header className={isDark ? 'sticky top-0 z-50 border-b border-white/10 bg-[#0d0d0d]/95 backdrop-blur' : 'sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur'}>
      <div className="mx-auto flex w-full max-w-[1200px] items-center justify-between gap-4 px-4 py-3">
        ...
        <div className={isDark ? 'hidden w-full max-w-[280px] items-center overflow-hidden rounded-lg border border-white/10 bg-[#1f1f1f] opacity-70 md:flex' : 'hidden w-full max-w-[280px] items-center overflow-hidden rounded-lg border border-slate-200 bg-slate-100 opacity-70 md:flex'}>
          <input
            type="text"
            readOnly
          ...
          />
          <button type="button" className="inline-flex h-10 w-11 items-center justify-center bg-emerald-500 text-white">
