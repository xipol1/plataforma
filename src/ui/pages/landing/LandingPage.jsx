    ...
    <div className={isDark ? 'relative overflow-hidden bg-[#0a0a12] text-white' : 'relative overflow-hidden bg-slate-50 text-slate-900'}>
      ...
      <section className="relative mx-auto grid w-full max-w-[1240px] gap-12 px-4 pb-16 pt-[120px] md:px-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pb-24">
        <div>
          ...
          <h1 className="mt-6 max-w-2xl font-['Sora'] text-[48px] font-bold leading-[1.1] tracking-tight">
            Compra espacios publicitarios en comunidades reales
          </h1>
          <p className={isDark ? 'mt-6 max-w-2xl text-base leading-7 text-indigo-100/80 md:text-lg' : 'mt-6 max-w-2xl text-base leading-7 text-slate-600 md:text-lg'}>
          ...
          <form className="mt-8 w-full max-w-[720px]" onSubmit={(event) => event.preventDefault()}>
            <div className={isDark ? 'flex h-[60px] items-center gap-2 rounded-xl border border-white/10 bg-white/[0.06] px-4 shadow-[0_10px_30px_rgba(0,0,0,0.15)]' : 'flex h-[60px] items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 shadow-[0_10px_30px_rgba(0,0,0,0.15)]'}>
              ...
              <button
                type="button"
                className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-500 text-white shadow-sm transition-transform hover:-translate-y-[1px]"
              >
        ...
        <div className={isDark ? 'rounded-3xl border border-white/10 bg-white/[0.06] p-4 shadow-xl backdrop-blur-xl opacity-90 lg:origin-top-right lg:scale-[0.88]' : 'rounded-3xl border border-slate-200 bg-white/80 p-4 shadow-xl backdrop-blur opacity-90 lg:origin-top-right lg:scale-[0.88]'}>
