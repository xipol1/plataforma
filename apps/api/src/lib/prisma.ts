    ...
    if (usePgMem) {
      ...
      void (async () => {
        ...
        await memPool.query(`
          ...
          SELECT '44444444-4444-4444-4444-444444444444', u.id, '11111111-1111-1111-1111-111111111111', 'Prueba nuestra plataforma para lanzar anuncios en canales cerrados.', 'https://example.com/landing', 'DRAFT'::"CampaignStatus"
